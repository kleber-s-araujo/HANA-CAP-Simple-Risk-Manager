/* checksum : 5eac7e4a97701c99a45e7faf067f211c */
@cds.external : true
...
entity BusinessPartnerA2X.A_BPAddressIndependentEmail {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BusinessPartnerA2X.A_BPAddressIndependentFax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BusinessPartnerA2X.A_BPAddressIndependentMobile {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BusinessPartnerA2X.A_BPAddressIndependentPhone {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BusinessPartnerA2X.A_BPAddressIndependentWebsite {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BusinessPartnerA2X.A_BPEmployment {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BusinessPartnerA2X.A_BusinessPartner {
  ...
  TradingPartner : String(6);
  @cds.ambiguous : 'missing on condition?'
  to_AddressIndependentEmail : Association to many BusinessPartnerA2X.A_BPAddressIndependentEmail {  };
  @cds.ambiguous : 'missing on condition?'
  to_AddressIndependentFax : Association to many BusinessPartnerA2X.A_BPAddressIndependentFax {  };
  @cds.ambiguous : 'missing on condition?'
  to_AddressIndependentMobile : Association to many BusinessPartnerA2X.A_BPAddressIndependentMobile {  };
  @cds.ambiguous : 'missing on condition?'
  to_AddressIndependentPhone : Association to many BusinessPartnerA2X.A_BPAddressIndependentPhone {  };
  @cds.ambiguous : 'missing on condition?'
  to_AddressIndependentWebsite : Association to many BusinessPartnerA2X.A_BPAddressIndependentWebsite {  };
  @cds.ambiguous : 'missing on condition?'
  ...
  @cds.ambiguous : 'missing on condition?'
  to_BPEmployment : Association to many BusinessPartnerA2X.A_BPEmployment {  };
  @cds.ambiguous : 'missing on condition?'
  ...
  @cds.ambiguous : 'missing on condition?'
  to_BusinessPartnerAlias : Association to many BusinessPartnerA2X.A_BusinessPartnerAlias {  };
  @cds.ambiguous : 'missing on condition?'
  ...
  @cds.ambiguous : 'missing on condition?'
  to_BusinessPartnerIsBank : Association to BusinessPartnerA2X.A_BusinessPartnerIsBank {  };
  @cds.ambiguous : 'missing on condition?'
...
entity BusinessPartnerA2X.A_BusinessPartnerAlias {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BusinessPartnerA2X.A_BusinessPartnerIsBank {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
